  ...
  return (
    ...
    <div className="bg-surface text-on-surface font-body-lg w-full h-full flex flex-col">
      ...
      <main className="flex-1 overflow-y-auto no-scrollbar">
        {/* Route Summary Panel */}
        <div className="bg-surface-container-lowest px-container-padding py-stack-lg shadow-m3-1 border-b border-surface-variant">
          ...
          <div className="mt-stack-md flex gap-2 overflow-x-auto pb-2 no-scrollbar">
            <div className="flex-shrink-0 bg-primary text-on-primary px-4 py-2 rounded-pill text-label-sm shadow-sm">
        ...
        {/* Flight List */}
        <StaggeredList className="px-container-padding pt-stack-md pb-4 flex flex-col gap-stack-md">
          {flights.map((flight) => {
            ...
            return (
              <button 
                ...
                className={`w-full text-left bg-surface-container-lowest rounded-xl p-4 relative overflow-hidden transition-all active:scale-[0.99] ${
                  isSelected 
                    ? 'border-2 border-primary shadow-m3-3' 
                    : 'border border-outline-variant shadow-m3-1 hover:shadow-m3-2'
                }`}
              >
                {isSelected && (
